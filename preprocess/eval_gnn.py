...
dataset = "icews14"
data_type = "test"
candidates_file = f"test_candidates.pkl"
dir_path = "./preds/" + dataset + "/"
...
if data_type == "valid":
    ...
    test_data = pkl.load(open(dir_path + "train_edges.pkl", "rb"))  # --- IGNORE ---
...
all_candidates = pkl.load(open(dir_path + candidates_file, "rb"))
...
# test_edges = pkl.load(open(dir_path + "test_edges.pkl", "rb"))
